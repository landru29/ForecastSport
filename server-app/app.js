...
// log stream
var logger = require(__dirname + '/services/logger')({file: __dirname + '/' + conf.log.file});
...
app.use(getMiddleware('cors', {domains:conf.cors}));
app.use(getMiddleware('token'));
app.use(getMiddleware('filesystem', {basePath: __dirname, public: conf.public}));
